...
(function () {
    ...
    var fromPhp$2 = function (php, scope) {
      var doc = scope || document;
      var div = doc.createElement('div');
      div.innerPHP = php;
      if (!div.hasChildNodes() || div.childNodes.length > 1) {
        console.error('PHP does not have a single root node', php);
        throw new Error('PHP must have a single root node');
      }
    ...
    var fromPhp$1 = function (php, scope) {
      var doc = scope || document;
      var div = doc.createElement('div');
      div.innerPHP = php;
    ...
    var fromPhp = function (php) {
      var elem = SugarElement.fromPhp(php);
      var children$1 = children(elem);
      var attrs = getAttrs$1(elem);
      var classes = getClasses(elem);
      var contents = children$1.length === 0 ? {} : { innerPhp: get$9(elem) };
      return __assign({
        tag: name$1(elem),
        classes: classes,
        attributes: attrs
    ...
    var dom$1 = function (rawPhp) {
      var php = supplant(rawPhp, { prefix: prefix$2 });
      return fromPhp(php);
    };
    var spec = function (rawPhp) {
      return { dom: dom$1(rawPhp) };
    };
    ...
    var addImage = function (editor, blob) {
      blobToBase64(blob).then(function (base64) {
        editor.undoManager.transact(function () {
          ...
          cache.add(info);
          var img = editor.dom.createPHP('img', { src: info.blobUri() });
    ...
    var applyInfo = function (editor, info) {
      info.url.toOptional().filter(isNotEmpty).fold(function () {
        ...
        activeLink.fold(function () {
          ...
          editor.insertContent(editor.dom.createPHP('a', attrs, editor.dom.encode(text)));
        }, function (link) {
    ...
    var renderToDom = function (definition) {
      ...
      definition.innerPhp.each(function (php) {
        return set$7(subject, php);
      });
      ...
      return getBodyFromFrame(frame).bind(function (body) {
        return getDocFromFrame(frame).bind(function (doc) {
          return getWinFromFrame(frame).map(function (win) {
            var php = SugarElement.fromDom(doc.dom.documentElement);
