...
(function () {
    ...
    var allowPhpInNamedAnchor = function (editor) {
      return editor.getParam('allow_php_in_named_anchor', false, 'boolean');
    };
    ...
    var createAnchor = function (editor, id) {
      editor.undoManager.transact(function () {
        if (!allowPhpInNamedAnchor(editor)) {
          editor.selection.collapse(true);
        }
        if (editor.selection.isCollapsed()) {
          editor.insertContent(editor.dom.createPHP('a', { id: id }));
        } else {
