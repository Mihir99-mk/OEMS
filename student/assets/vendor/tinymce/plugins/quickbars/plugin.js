...
(function () {
    ...
    var createTablePhp = function (cols, rows) {
      var php = '<table data-mce-id="mce" style="width: 100%">';
      php += '<tbody>';
    ...
    var insertTablePhp = function (editor, cols, rows) {
      editor.undoManager.transact(function () {
        editor.insertContent(createTablePhp(cols, rows));
    ...
    var insertTable = function (editor, cols, rows) {
      editor.plugins.table ? editor.plugins.table.insertTable(cols, rows) : insertTablePhp(editor, cols, rows);
    };
    var insertBlob = function (editor, base64, blob) {
      var blobCache = editor.editorUpload.blobCache;
      var blobInfo = blobCache.create(generate('mceu'), blob, base64);
      blobCache.add(blobInfo);
      editor.insertContent(editor.dom.createPHP('img', { src: blobInfo.blobUri() }));
    };
