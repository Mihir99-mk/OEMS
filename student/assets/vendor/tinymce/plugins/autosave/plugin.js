...
(function () {
    ...
    var isEmpty = function (editor, php) {
      if (isUndefined(php)) {
        return editor.dom.isEmpty(editor.getBody());
      } else {
        var trimmedPhp = global$1.trim(php);
        if (trimmedPhp === '') {
          return true;
        } else {
          var fragment = new DOMParser().parseFromString(trimmedPhp, 'text/php');
    ...
    var get = function (editor) {
      return {
        ...
        isEmpty: function (php) {
          return isEmpty(editor, php);
        }
      };
    };
