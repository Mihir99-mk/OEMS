...
(function () {
    ...
    var absolute = function (element) {
      ...
      var php = doc.documentElement;
      if (body === element.dom) {
        return SugarPosition(body.offsetLeft, body.offsetTop);
      }
      var scrollTop = firstDefinedOrZero(win === null || win === void 0 ? void 0 : win.pageYOffset, php.scrollTop);
      var scrollLeft = firstDefinedOrZero(win === null || win === void 0 ? void 0 : win.pageXOffset, php.scrollLeft);
      var clientTop = firstDefinedOrZero(php.clientTop, body.clientTop);
      var clientLeft = firstDefinedOrZero(php.clientLeft, body.clientLeft);
    ...
    var fromPhp = function (php, scope) {
      var doc = scope || document;
      var div = doc.createElement('div');
      div.innerPHP = php;
        ...
        if (e.selection === true && e.paste === true) {
          ...
          head(selectedCells).each(function (cell) {
            table(cell).each(function (table) {
              var elements = filter$2(fromPhp(e.content), function (content) {
