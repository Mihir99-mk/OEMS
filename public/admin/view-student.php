                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            $data = $Admin->viewStudent($adminId);
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                ?><tr>
                                                    ...
                                                    <td><a href="student-profile.php?sid=<?php echo $val["studId"]; ?>"  class="btn btn-secondary">View</a></td>
                                                    <td><a href="faculty-update.php?sid=<?php echo $val["studId"]; ?>"  class="btn btn-primary">Update</a></td>
                                                    <td><a href="student-delete.php?sid=<?php echo $val["studId"]; ?>"  class="btn btn-danger">Delete</a></td>
                                                    </tr> 
                                                <?php
