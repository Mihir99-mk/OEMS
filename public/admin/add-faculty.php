                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if (empty($quali)) {
                                $Facvaild = false;
                                $Facultyerrors['cn8'] = "Qualification cannot be empty";
                            }
                            ...
                            if ($Facvaild) {
                                ...
                                $data = $Admin->faculty($adminId, $fname, $lname, $address, $phoneno, $email, $password, $gender, $quali, $target_file, $dob);
                                $name = $fname . " " . $lname;
                                ...
                                if ($data == 0) {
                                    $Facultyerrors["success"] = "Faculty added successfully!!";
                                } else {
                                    $Facultyerrors["fail"] = "Faculty added failed!!";
                                }
                            }
                        }
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" method="POST" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="col-12">
                                            <label for="inputNanme4" class="form-label">Qualification</label>
                                            <select class="form-select" name="quali" aria-label="Default select example">
                                                ...
                                                <option value="B.C.A">Bachelor of Computer Applications - B.C.A</option>
                                                ...
                                                <option value="M.E./ M.Tech">Master of Engineering / Master of Technology - M.E./ M.Tech</option>
                                            </select>
                                            <div class="a"> <?php if (isset($Facultyerrors['cn8'])) {
                                                                echo $Facultyerrors['cn8'];
                                                            } ?> </div>
                                        </div>
                                        <div class="col-12">
