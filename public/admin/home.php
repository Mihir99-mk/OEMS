    ...
    <nav class="navbar navbar-expand-lg py-lg-3 navbar-dark">
        <div class="container">
            ...
            <a href="index.html" class="navbar-brand me-lg-5">
                <img src="./assets/images/logo.png" height="80px" width="210px">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item me-0">
                        <a href="../../product/hyper-responsive-admin-dashboard-template/index.htm" target="_blank" class="nav-link d-lg-none"></a>
                ...
                <div class="col-md-5">
                    <div class="mt-md-4">
                        ...
                        <h2 class="text-white fw-normal mb-4 mt-3 hero-title">
                            OEMS Online Examination System
                        </h2>

                        <p class="mb-4 font-16 text-white-50">OEMS is a online examination system which test student knowledge via Quiz test. It gives our user many options to create quizes for student.
                            Our motto is to provide ease of use of this system and ability to create quize's
                        </p>
            ...
            <div class="row">
                <div class="col-lg-6" style="width: 100%; ">
                    <div style="display: flex; align-items: center; justify-content: center;">
                        <img src="assets/images/logo.png" alt="" class="logo-dark" height="100px" width="150px">
                        <p class="text-muted mt-4"> OEMS makes it easier to build better quiz with
                            <br> great speed. Saves time.
                        </p>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mt-5">
                                <p class="text-muted mt-4 text-center mb-0">© OEMS Online Examination Management System </p>
                            </div>
                        </div>
                    </div>
                </div>
