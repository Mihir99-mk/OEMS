            ...
            <div class="content">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if ($batchvaild) {
                        ...
                        $data = $Admin->course($adminId, $cname);

                        if ($data == 0) {
                            $batcherrors["success"] = "Course added successfully!!";
                        } else {
                            $batcherrors["fail"] = "Course added failed!!";
                        }
                    }
                }
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" method="POST" novalidate>
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="coursename" class="form-control" id="inputNanme4" required>
