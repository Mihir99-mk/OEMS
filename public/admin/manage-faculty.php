        ...
        <div class="content-page">
            <div class="content">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (empty($cname)) {
                        $batchvaild = false;
                        $batcherrors['cn1'] = "faculty name cannot be empty";
                    }
                    if (empty($sname)) {
                        $batchvaild = false;
                    ...
                    if ($batchvaild) {
                        ...
                        foreach ($sData[0] as $data) {
                            $data = $Admin->manageFaculty($adminId, $cname, $data);
                        }

                        echo "<script>console.log(".$data.")</script>";

                        if ($data == 0) {
                            $batcherrors["success"] = "faculty and Subject assign successfully!!";
                        } 
                        // else {
                        ...
                        if ($data == 2) {
                            $batcherrors["assign"] = "This faculty was already assign this Subject please select another subject!!";
                        }
                    }
                }
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" method="POST" novalidate>
                                        <div class="col-12">
                                            <label for="inputNanme4" class="form-label">Faculty Name</label>

                                            <select class="form-select" name="facultyname" aria-label="Default select example">
                                                <?php
                                                foreach ($jdata as $v) {
                                                ?>
                                                    <option selected value="<?php echo $v["facId"]; ?>"><?php echo $v["fname"]." ".$v["lname"]; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="text-center">
                                            <button type="submit" name="submit" class="btn btn-primary">Assign Subject</button>
