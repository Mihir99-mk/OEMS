                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="page-title-right">
                                ...
                                <h4 class="page-title">View Faculty</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <table id="myTable" class="display">
                                        ...
                                        <tbody>
                                            ...
                                            ?><tr>
                                                    ...
                                                    <td><a href="faculty-profile.php?pid=<?php echo $val["facId"]; ?>" class="btn btn-secondary">View</a></td>
                                                    <td><a href="faculty-update.php?pid=<?php echo $val["facId"]; ?>" class="btn btn-primary">Update</a></td>
                                                    <td><a href="faculty-delete.php?pid=<?php echo $val["facId"]; ?>" class="btn btn-danger">Delete</a></td>
                                                </tr>
                                            <?php
