...
(function (global, factory) {
  ...
  // import { isPHPElement } from './instanceOf';
  ...
  includeScale) {
    ...
    // width or height.
    // if (isPHPElement(element) && includeScale) {
  ...
  function getOffsetParent(element) {
    ...
    if (offsetParent && (getNodeName(offsetParent) === 'php' || getNodeName(offsetParent) === 'body' && getComputedStyle$1(offsetParent).position === 'static')) {
      return window;
    }
  ...
  function getDocumentRect(element) {
    ...
    var width = max(php.scrollWidth, php.clientWidth, body ? body.scrollWidth : 0, body ? body.clientWidth : 0);
    var height = max(php.scrollHeight, php.clientHeight, body ? body.scrollHeight : 0, body ? body.clientHeight : 0);
    var x = -winScroll.scrollLeft + getWindowScrollBarX(element);
    var y = -winScroll.scrollTop;

    if (getComputedStyle$1(body || php).direction === 'rtl') {
      x += max(php.clientWidth, body ? body.clientWidth : 0) - width;
    }
  ...
  */
  ...
  function getCompositeRect(elementOrVirtualElement, offsetParent, isFixed) {
    ...
    isPHPElement(offsetParent) && isElementScaled(offsetParent);
  ...
  class Modal extends BaseComponent {
    ...
    dispose() {
      [window, this._dialog].forEach(phpElement => EventHandler.off(phpElement, EVENT_KEY$6));
  ...
  function sanitizePhp(unsafePhp, allowList, sanitizeFn) {
    ...
    const createdDocument = domParser.parseFromString(unsafePhp, 'text/php');
  ...
  class Tooltip extends BaseComponent {
    ...
    show() {
      ...
      if (this.constructor.NAME === 'tooltip' && this.tip && this.getTitle() !== this.tip.querySelector(SELECTOR_TOOLTIP_INNER).innerPHP) {
        this._disposePopper();
    ...
    getTipElement() {
      ...
      element.innerPHP = this._config.template;
    ...
    setElementContent(element, content) {
      ...
      if (this._config.php) {
        if (this._config.sanitize) {
          content = sanitizePhp(content, this._config.allowList, this._config.sanitizeFn);
        }
