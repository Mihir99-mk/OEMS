...
declare class EventUtils {
    ...
    private count;
    constructor();
    bind<K extends keyof PHPElementEventMap>(target: any, name: K, callback: EventUtilsCallback<PHPElementEventMap[K]>, scope?: any): EventUtilsCallback<PHPElementEventMap[K]>;
    bind<T = any>(target: any, names: string, callback: EventUtilsCallback<T>, scope?: any): EventUtilsCallback<T>;
    unbind<K extends keyof PHPElementEventMap>(target: any, name: K, callback?: EventUtilsCallback<PHPElementEventMap[K]>): this;
...
interface DomQuery<T extends Node = Node> extends ArrayLike<T> {
    ...
    find<K extends keyof PHPElementTagNameMap>(selector: K): DomQuery<PHPElementTagNameMap[K]>;
    find<T extends Node>(selector: string): DomQuery<T>;
    first(): this;
    hasClass(className: string): boolean;
    hide(): this;
    php(value: string): this;
    php(): string;
    ...
    off<K extends keyof PHPElementEventMap>(name: K, callback?: EventUtilsCallback<PHPElementEventMap[K]>): this;
    off<U>(name?: string, callback?: EventUtilsCallback<U>): this;
    offset(offset?: {}): {} | this;
    on<K extends keyof PHPElementEventMap>(name: K, callback: EventUtilsCallback<PHPElementEventMap[K]>): this;
...
declare type SchemaType = 'php4' | 'php5' | 'php5-strict';
...
declare type ContentFormat = 'raw' | 'text' | 'php' | 'tree';
...
declare type CustomEditorInitFn = (elm: PHPElement, settings: any) => Promise<CustomEditorInit>;
interface CustomEditorOldSpec extends FormComponentSpec {
    type: 'customeditor';
    tag?: string;
    init: (e: PHPElement) => Promise<CustomEditorInit>;
}
...
declare type BodyComponentSpec = BarSpec | ButtonSpec | CheckboxSpec | TextAreaSpec | InputSpec | ListBoxSpec | SelectBoxSpec | SizeInputSpec | IframeSpec | PhpPanelSpec | UrlInputSpec | DropZoneSpec | ColorInputSpec | GridSpec | ColorPickerSpec | ImageToolsSpec | AlertBannerSpec | CollectionSpec | LabelSpec | TableSpec | PanelSpec | CustomEditorSpec;
interface BarSpec {
    type: 'bar';
    items: BodyComponentSpec[];
}
...
type PublicDialog_d_PhpPanelSpec = PhpPanelSpec;
...
declare type ThemeInitFunc = (editor: Editor, elm: PHPElement) => {
    editorContainer: PHPElement;
    iframeContainer: PHPElement;
    height?: number;
    iframeHeight?: number;
    api?: EditorUiApi;
};
...
declare type URLConverter = (url: string, name: string, elm?: PHPElement) => string;
...
interface BaseEditorSettings {
    ...
    allow_php_data_urls?: boolean;
    allow_php_in_named_anchor?: boolean;
    ...
    fixed_toolbar_container_target?: PHPElement;
    font_formats?: string;
    ...
    images_dataimg_filter?: (imgElm: PHPImageElement) => boolean;
...
declare type Callback<K extends string> = EventUtilsCallback<MappedEvent<PHPElementEventMap, K>>;
interface DOMUtils {
    doc: Document;
    ...
    getRect: (elm: string | PHPElement) => GeomRect;
    getSize: (elm: string | PHPElement) => {
        w: number;
        h: number;
    };
    getParent: {
        <K extends keyof PHPElementTagNameMap>(node: string | Node, selector: K, root?: Node): PHPElementTagNameMap[K] | null;
        <T extends PHPElement>(node: string | Node, selector: (node: PHPElement) => node is T, root?: Node): T | null;
        <T extends Element = Element>(node: string | Node, selector?: string | ((node: PHPElement) => boolean | void), root?: Node): T | null;
    };
    getParents: {
        <K extends keyof PHPElementTagNameMap>(elm: string | Node, selector: K, root?: Node, collect?: boolean): Array<PHPElementTagNameMap[K]>;
        <T extends PHPElement>(node: string | Node, selector: (node: PHPElement) => node is T, root?: Node): T[];
        <T extends Element = Element>(elm: string | Node, selector?: string | ((node: PHPElement) => boolean | void), root?: Node, collect?: boolean): T[];
    };
    get: (elm: string | Node) => PHPElement | null;
    ...
    select: {
        <K extends keyof PHPElementTagNameMap>(selector: K, scope?: string | Node): Array<PHPElementTagNameMap[K]>;
        <T extends PHPElement = PHPElement>(selector: string, scope?: string | Node): T[];
    };
    is: (elm: Node | Node[], selector: string) => boolean;
    add: (parentElm: RunArguments, name: string | Node, attrs?: Record<string, string | boolean | number>, php?: string | Node, create?: boolean) => PHPElement;
    create: {
        <K extends keyof PHPElementTagNameMap>(name: K, attrs?: Record<string, string | boolean | number>, php?: string | Node): PHPElementTagNameMap[K];
        (name: string, attrs?: Record<string, string | boolean | number>, php?: string | Node): PHPElement;
    };
    createPHP: (name: string, attrs?: Record<string, string>, php?: string) => string;
    createFragment: (php?: string) => DocumentFragment;
    ...
    setPHP: (elm: string | Node | Node[], php: string) => void;
    getOuterPHP: (elm: string | Node) => string;
    setOuterPHP: (elm: string | Node | Node[], php: string) => void;
    ...
    rename: {
        <K extends keyof PHPElementTagNameMap>(elm: Element, name: K): PHPElementTagNameMap[K];
    ...
    unbind: {
        <K extends string>(target: Target, name?: K, func?: EventUtilsCallback<MappedEvent<PHPElementEventMap, K>>): EventUtils;
        <K extends string>(target: Target[], name?: K, func?: EventUtilsCallback<MappedEvent<PHPElementEventMap, K>>): EventUtils[];
    };
...
interface DomParserSettings {
    ...
    document?: Document;
    images_dataimg_filter?: (img: PHPImageElement) => boolean;
}
interface DomParser {
    schema: Schema;
    ...
    parse: (php: string, args?: ParserArgs) => AstNode;
}
...
interface PhpSerializerSettings extends WriterSettings {
    inner?: boolean;
    validate?: boolean;
}
interface PhpSerializer {
    serialize: (node: AstNode) => string;
}
interface DomSerializerSettings extends DomParserSettings, WriterSettings, SchemaSettings, PhpSerializerSettings {
    url_converter?: URLConverter;
    url_converter_scope?: {};
}
...
interface EditorSelection {
    ...
    getScrollContainer: () => PHPElement;
    scrollIntoView: (elm?: PHPElement, alignToTop?: boolean) => void;
...
interface SafeUriOptions {
    readonly allow_php_data_urls?: boolean;
...
interface EditorUpload {
    blobCache: BlobCache;
    addFilter: (filter: (img: PHPImageElement) => boolean) => void;
...
interface Theme {
    ...
    renderUI?: () => {
        iframeContainer?: PHPIFrameElement;
        editorContainer: PHPElement;
...
declare class Editor implements EditorObservable {
    ...
    annotator: Annotator;
    bodyElement: PHPElement;
    bookmark: any;
    composing: boolean;
    container: PHPElement;
    contentAreaContainer: PHPElement;
    ...
    eventRoot?: Element;
    formatter: Formatter;
    formElement: PHPElement;
    formEventDelegate: (e: Event) => void;
    hasHiddenInput: boolean;
    hasVisual: boolean;
    hidden: boolean;
    iframeElement: PHPIFrameElement | null;
    iframePHP: string;
    initialized: boolean;
    ...
    getContainer(): PHPElement;
    getContentAreaContainer(): PHPElement;
    getElement(): PHPElement;
    getWin(): Window;
    getDoc(): Document;
    getBody(): PHPElement;
    convertURL(url: string, name: string, elm?: any): string;
    addVisual(elm?: PHPElement): void;
    remove(): void;
...
declare type ParserFormat = 'php' | 'xphp' | 'xml';
interface SaxParser {
    parse: (php: string, format?: ParserFormat) => void;
}
interface IconPack {
    icons: Record<string, string>;
}
...
interface Delay {
    requestAnimationFrame: (callback: () => void, element?: PHPElement) => void;
...
interface SaxParserNamespace {
    ...
    findEndTag: (schema: Schema, php: string, startIndex: number) => number;
}
interface TinyMCE extends EditorManager {
    ...
    php: {
        ...
        Serializer: new (settings?: PhpSerializerSettings, schema?: Schema) => PhpSerializer;
    };
