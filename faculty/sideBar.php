        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="add-student.php">
              <i class="bi bi-circle-fill"></i><span>Add Students</span>
            </a>
          </li>
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="view-subject.php">
              <i class="bi bi-circle-fill"></i><span>View Subjects</span>
            </a>
          </li>
          <li>
            <a href="add-subject.php">
              <i class="bi bi-circle-fill"></i><span>Add Subjects</span>
            </a>
          </li>
        </ul>
      </li><!-- End Forms Nav -->
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="add-result.php">
              <i class="bi bi-circle-fill"></i><span>Add Result</span>
            </a>
          </li>
        </ul>
      </li><!-- End Charts Nav -->
